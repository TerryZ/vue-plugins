...
describe('v-region Group 多级别分组模式', function () {
  ...
  it('选择 “天津市”，当前级别自动切换至 “市” 级', async () => {
    await w.findAll('.rg-results li').at(1).trigger('click')
  ...
  it('选择 “天津市”，当前级别自动切换至 “区/县” 级', async () => {
    await w.findAll('.rg-results li').at(0).trigger('click')
