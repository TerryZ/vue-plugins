...
describe('v-dialogs', function () {
  describe('open all type dialogs', () => {
    ...
    it('open a Modal dialog', () => {
      ...
      expect(wapper.find('.v-dialog-modal').exists()).to.equal(true)
    })
    it('open a Alert dialog', () => {
      ...
      expect(wapper.find('.v-dialog-alert').exists()).to.equal(true)
    })
    it('open a Mask dialog', () => {
      ...
      expect(wapper.find('.v-dialog-mask__container').exists()).to.equal(true)
    })
    it('open a Toast dialog', () => {
      ...
      expect(wapper.find('.v-dialog-toast__container').exists()).to.equal(true)
    })
