...
export default {
    render(h){
        ...
        child.push(this.build(h, this.listProvince, this.dProvince, val=>this.dProvince = val));

        if(this.city){
            child.push(this.build(h, this.listCity, this.dCity, val=>this.dCity = val));
        }
        if(this.city && this.area){
            child.push(this.build(h, this.listArea, this.dArea, val=>this.dArea = val));
        }
        if(this.city && this.area && this.town && this.haveTown){
            child.push(this.build(h, this.listTown, this.dTown, val=>this.dTown = val));
        }
