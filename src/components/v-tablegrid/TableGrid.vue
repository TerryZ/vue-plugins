...
export default {
  ...
  computed: {
    ...
    pagerOptions () {
      ...
      if (this.pageSizeMenu === false || (Array.isArray(this.pageSizeMenu) && this.pageSizeMenu.length)) { options['page-size-menu'] = this.pageSizeMenu }
      return options
    },
    tableTheme () {
      return {
  ...
  methods: {
    titleClass (index, align) {
      ...
      }; const cls = this.alignClass(align)
