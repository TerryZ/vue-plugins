<template>
  <div class="card p-5">
    ...
    <h4 class="mt-3">
      单文件上传 <small>自定义预览区尺寸、自定义按钮文件、自定义是否显示按钮图标，自定义初始预览图片</small>
    </h4>
    <v-uploader
      :preview-width="400"
      :preview-height="300"
    ...
    <h4 class="mt-3">
      单文件无预览上传 <small>结合图片预览插件功能，控制上传数量</small>
    </h4>
    ...
    <v-uploader
      ...
      file-type-exts="jpeg,jpg,gif,png,mp4"
      @done="customUpload"
    />

    <h4 class="mt-3">
      批量上传 <small>限制文件上传数量</small>
    </h4>
    <v-uploader
      :multiple="true"
      :item-limit="2"
