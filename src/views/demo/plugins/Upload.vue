<template>
    <div class="panel panel-default">
        <div class="panel-body">
            <h3>v-uploader <button type="button" class="btn btn-inverse btn-xs" @click="$router.push({path: '/demo'});">Back to List</button></h3>
            <!--<div class="btn singleFileUpload" ref="upload"><i class="fa fa-fw fa-upload"></i> 文件上传</div>-->
            <h4>单文件上传 <small>自定义预览区尺寸、自定义按钮文件、自定义是否显示按钮图标，自定义初始预览图片</small></h4>
            ...
            <h4>单文件无预览上传 <small>结合图片预览插件功能，控制上传数量</small></h4>
            ...
            <h4>批量上传 <small>限制文件上传数量</small></h4>
