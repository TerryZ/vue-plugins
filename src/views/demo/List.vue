  ...
  <div>
    ...
    >
      <template slot-scope="props">
        <td v-text="props.row.login_name" />
        <td v-text="props.row.name" />
        <td v-text="props.row.sexName" />
        <td v-text="props.row.birthday" />
        <td v-text="props.row.phone1" />
        <td v-text="props.row.email" />
        <td v-text="props.row.statusName" />
        <td v-text="props.row.update_time" />
        <td>
          <button
            type="button"
            class="btn btn-primary btn-xs"
            @click.stop="showInfo(props.row)"
          >
            添加
          </button>
        </td>
